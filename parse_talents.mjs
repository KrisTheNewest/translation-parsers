...
import { russianEntries } from "./russianNames.mjs";

const charaTalents = {};

console.time("Succesfully saved the file in");
const talentsFile = xlsx.parse(`./tl/jet_talents.xlsx`);
talentsFile.shift();
...
writeFile(`./tl/parsed_talents.json`, JSON.stringify(charaTalents, null, 2))
